...
from chzzk.utile.email_noti import email
from utile.space import getFreeSpace
        ...
        while not shutdown_event.is_set():
            ...
            if stream_url:
                ...
                try:
                    ...
                    temp_output_file = shorten_filename(f"{channel_name}_chzzk_{current_time.replace(':', '').replace('-', '').replace(' ', '_')}.ts.part")
                    #shorten_filename(
                    ...
                    email(f'({getFreeSpace(output_dir)})Chzzk : Start, {channel_name}, {live_title}', '')
                    ...
                    try:
                        ...
                        if temp_output_path.exists():
                            ...
                            email(f'({getFreeSpace(output_dir)})Chzzk : End, {channel_name}, {live_title}', '')
...
if __name__ == "__main__":
    email('Chzzk : Boot', 'Start monitoring')
    asyncio.run(main())
